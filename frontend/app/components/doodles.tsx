...
export function DrinkGlass({
  ...
  return (
    <svg viewBox="0 0 120 170" aria-hidden className={className} style={style}>
      <defs>
        <clipPath id={`glass-${top.slice(1)}${bottom.slice(1)}`}>
          <path d="M22 20h76l-8 132a14 14 0 0 1-14 12H44a14 14 0 0 1-14-12Z" />
        </clipPath>
      </defs>
      <g clipPath={`url(#glass-${top.slice(1)}${bottom.slice(1)})`}>
        ...
        <rect x="24" y="16" width="10" height="156" fill="#fff" opacity="0.35" />
      </g>
      <path
